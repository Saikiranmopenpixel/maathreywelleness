...
export const metadata = {
  title: "Policy - Maathrey Wellness",
};
  ...
  return (
    <Wrapper>
      ...
      <SectionTop
        ...
        subtitle={
          <>
            Your privacy is important to us. It is Maathrey Wellness policy to respect
            your privacy regarding <br /> any information we may collect from
            you across our website, https://maathreypharmaceuticals.com, <br /> and other sites
            we own and operate.
          </>
        }
      />
