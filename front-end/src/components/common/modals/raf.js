            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                <div className="product__details-wrapper">
                  ...
                  <p className="mt-20">
                  Maathrey Wellness is a dedicated healthcare company focused on providing high-quality pharmaceutical and nutraceutical products that support better health and everyday wellness.
                  </p>
                  {/* Price */}
                  <OldNewPrice
