...
const slider_data = [
  {
    ...
    title: (
      <>
        Explore high-quality medicines <br /> and nutraceutical products.
      </>
    ),
    img: slider_img_1,
  },
  {
    ...
    pre_title: (
      <>
        Your Trusted Partner in <br /> Health & Wellness
      </>
    ),
    title: (
      <>
        Premium tablets, capsules, <br /> and supplements for everyday care.
      </>
    ),
    img: slider_img_2,
  },
  {
    ...
    pre_title: (
      <>
        Quality Healthcare <br /> Solutions for a Better Life
      </>
    ),
    title: (
      <>
        Supporting your wellness with trusted <br /> pharmaceutical and nutraceutical products.
      </>
    ),
    img: slider_img_3,
  },
